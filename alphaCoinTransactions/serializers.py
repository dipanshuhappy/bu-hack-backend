...
from .services import is_sender_same_batch_with_receiver
class AlphaTransactionSerializer(serializers.ModelSerializer):
    class Meta:
        model=AlphaTransaction
        fields=[
            'id',
            'sender_id',
            'receiver_id',
...
class AlphaTransactionListQuerySerializer(serializers.Serializer):
...
class AlphaRequestTransactionSerializer(serializers.ModelSerializer):
...
class AlphaRequestTransactionGetSerializer(serializers.ModelSerializer):
      class Meta:
        model=AlphaRequestTransaction
        fields=(
            'id',
